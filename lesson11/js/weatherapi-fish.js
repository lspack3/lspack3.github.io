...
const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5585010&appid=a74c7e35f6bf8eabf46deae3c9db19c3&units=imperial";
...
fetch("https://api.openweathermap.org/data/2.5/forecast?id=5585010&appid=a74c7e35f6bf8eabf46deae3c9db19c3&units=imperial")
  .then((response) => response.json())
  .then((jsObject) => {
  console.table(jsObject);
  console.log(jsObject);  // for testing
